...
Ми **не** використовуємо сторонні системи аналітики, пікселі чи скрипти відстеження (включно з Google Analytics та Google Tag Manager) і не встановлюємо трекінгові файли cookie на «Веб-сайті».

B. Файли cookie та механізми відстеження

Оскільки аналітику видалено, ми не застосовуємо трекінгові cookie або подібні технології. Стандартні журнали запитів, що створюються хостинг-провайдером для безпеки та надійності (наприклад, для виявлення зловживань), можуть існувати, але ми не агрегуємо їх, не профілюємо та не комерціалізуємо.
...
Ми не передаємо, не продаємо, не здаємо в оренду і не обмінюємо вашу персональну інформацію з будь-якими третіми сторонами та не надсилаємо дані постачальникам аналітики чи реклами.

B. Зберігання даних

Оскільки ми не збираємо аналітичні чи трекінгові дані, нам нічого зберігати для цих цілей.

C. Безпека даних

Ми застосовуємо комерційно розумні заходи безпеки (наприклад, використання HTTPS) для захисту передачі даних «Веб-сайту».
...
Відповідно до застосовних законів про захист даних (таких як GDPR або CCPA) ви можете мати певні права. Оскільки ми не збираємо персональні дані через «Веб-сайт», ці права зазвичай не активуються при відвідуванні сайту; вони залишаються чинними для будь-якої інформації, яку ви добровільно надасте нам безпосередньо (наприклад, електронною поштою).
